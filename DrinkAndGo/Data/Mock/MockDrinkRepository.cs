...
namespace DrinkAndGo.Data.Mock
{
    public class MockDrinkRepository : IDrinkRepository
    {
            ...
            get
            {
                return new List<Drink>
                {
                     new Drink {
                        ...
                        ImageThumbnailUrl = "https://wallpaperaccess.com/full/1105642.jpg"
                    },
                    new Drink {
                        Name = "Rum & Coke",
                        ...
                        ImageThumbnailUrl = "https://www.umami.site/wp-content/uploads/2016/03/Rum-Coke-1.jpg"
                    },
                    new Drink {
                        Name = "Tequila ",
                        ...
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "https://i.pinimg.com/originals/2c/75/6e/2c756e6ef821be99cbfa2793cec13c93.jpg"
                    },
                    new Drink
                    {
                        Name = "Juice ",
                        ...
                        InStock = true,
                        IsPreferredDrink = false,
                        ImageThumbnailUrl = "https://wallpapercave.com/wp/wp1907116.jpg"
                    }
                };
            }
        }
        ...
        public IEnumerable<Drink> PreferedDrink { get => throw new System.NotImplementedException(); set => throw new System.NotImplementedException(); }
